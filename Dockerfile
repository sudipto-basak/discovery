...
COPY target/discovery-0.0.1-SNAPSHOT.jar /opt/microservices/lib/app.jar
...
ENV JAVA_OPTS="-Xms128m -Xmx512m -XshowSettings:vm -Dspring.profiles.active=docker"
ENTRYPOINT ["sh"]
#CMD["/opt/microservices/scripts/entrypoint.sh"]
